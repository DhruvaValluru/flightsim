...
`python -m flightsim.capture examples/cameras_multi_cockpit.yaml --out runs/demo_b` -- exit 0, 2.35 s wall
...
`python -m flightsim.verify runs/demo --corrupt count` -- exit 1, 0.28 s wall
